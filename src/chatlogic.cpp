...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // // pass-by-reference because otherwise a copy is made (in the case of unique pointer, move would occur)
    ...
    ChatBot chatBot = ChatBot("../images/chatbot.png"); // creating a ChatBot instance on the stack. We will move it's ownership to the root node. 
    _chatBot = &chatBot;
